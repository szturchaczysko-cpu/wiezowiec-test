    ...
    try:
        ...
        for cel, info in memory.items():
            ...
            if result.get("success") and result.get("posts"):
                ...
                human_replies = [p for p in posts if p.get("Id") != forum_id]
    ...
    for cel, info in FORUM_THREADS.items():
        ...
        try:
            ...
            for post in result["posts"]:
                # Rozpoznaj wpisy AI po disclaimerze (niezależnie od autora)
                if "Jestem Chatoszturkiem AI" not in post.get("Text", ""):
                    continue
                text = post.get("Text", "")
