        ...
        if not queue_doc or not queue_doc.exists:
            ...
            if processed >= total:
                ...
                if case_info is None:
                    ...
                    # Mapowanie: Stats nazwa → forum nick
                    _OP_FORUM_NICK = {"Kasia": "kasia_k"}
                    case_operator_forum = _OP_FORUM_NICK.get(case_operator, case_operator)
                    ...
                    parametry = f"""
# PARAMETRY STARTOWE
domyslny_operator={case_operator_forum}
            ...
            if st.button("🚀 Przelicz tym promptem", key="test_calculate", type="primary"):
                if _tp_save and _pk_data.get("autopilot_status"):
                    ...
                    try:
                        ...
                        _OP_FORUM_NICK_T = {"Kasia": "kasia_k"}
                        _case_op_forum = _OP_FORUM_NICK_T.get(_case_op, _case_op)
                        
                        _params_t = f"""
# PARAMETRY STARTOWE
domyslny_operator={_case_op_forum}
