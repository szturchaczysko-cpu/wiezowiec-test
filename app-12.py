                ...
                with _fa_c3:
                    if st.button("🔓 Uwolnij", key=f"release_fa_{_fa_id}"):
                        ...
                        if _fa_tag and _fa_tag != "brak":
                            ...
                            if _old_tag_match:
                                _new_wsad = _old_wsad.replace(_old_tag_match.group(0), _fa_tag)
                            else:
                                _new_wsad = _old_wsad + "\n" + _fa_tag
            ...
            if st.button("🔓 Uwolnij WSZYSTKIE", key="release_all_fa"):
                for _fa_id, _fa_data in _fa_cases:
                    ...
                    if _fa_tag_all:
                        ...
                        _old_tag_match_all = re.search(r'[Cc]#:[^\n]+', _old_wsad_all)
                        if _old_tag_match_all:
                            _new_wsad_all = _old_wsad_all.replace(_old_tag_match_all.group(0), _fa_tag_all)
                        else:
